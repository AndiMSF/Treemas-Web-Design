...
const MasterDataAnnouncementEdit = () => {
  ...
  useEffect(() => {
    const fetchAnnouncementData = async () => {
      try {
        const response = await axios.get(`https://treemas-api-405402.et.r.appspot.com/api/master-data/announcement-form/${id}`, {
          headers: {
  ...
  // Data sebelumnya
  const { state: { selectedAnnouncement } } = useLocation();
