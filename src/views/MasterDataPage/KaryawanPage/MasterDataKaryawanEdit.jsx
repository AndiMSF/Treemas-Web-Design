...
const MasterDataKaryawanEdit = () => {
    ...
    const [apiEdit, setApiEdit] = useState(`https://treemas-api-405402.et.r.appspot.com/api/master-data/karyawan-form/edit/${id}`);
