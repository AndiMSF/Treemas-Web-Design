...
const MasterDataKaryawan = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetch('https://treemas-api-405402.et.r.appspot.com/api/master-data/karyawan-view', {
      ...
      const handleDelete = (id) => {
          ...
          try {
            const response = await fetch(`https://treemas-api-405402.et.r.appspot.com/api/master-data/karyawan-form/delete/${id}`, {
              method: 'DELETE',
              headers: {
                'Content-Type': 'application/json',
            ...
            if (response.ok) {
              ...
              setApiData((prevData) => prevData.filter(item => item.nik !== id));
            } else {
              // Gagal dihapus
              Swal.fire({
                title: "Error!",
