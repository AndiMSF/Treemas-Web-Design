...
const MasterDataKaryawan = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetch('https://treemas-api-403500.et.r.appspot.com/api/master-data/karyawan-view', {
      ...
      const handleDelete = (id) => {
          ...
          try {
            const response = await fetch(`https://treemas-api-403500.et.r.appspot.com/api/master-data/karyawan-form/delete/${id}`, {
              method: 'DELETE',
              headers: {
                'Content-Type': 'application/json',
