...
const ParameterReimburse = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetch('https://treemas-api-405402.et.r.appspot.com/api/parameter/reimburse-view', {
      ...
      const handleDelete = (id) => {
          ...
          try {
            const response = await fetch(`https://treemas-api-405402.et.r.appspot.com/parameter/reimburse-form/edit/${id}`, {
              method: 'DELETE',
              headers: {
                'Content-Type': 'application/json',
