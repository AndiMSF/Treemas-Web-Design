...
const ParameterReimburseEdit = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await axios.put(`https://treemas-api-405402.et.r.appspot.com/api/parameter/reimburse-form/edit/${id}`, 
          requestData,
          {
            headers: {
    ...
    const { state: { selectedReimburse } } = useLocation ();
          ...
          <div className="content__container">
                ...
                <div className="form__row">
                    ...
                    <div className="form__row__right">
                        <BoxInput placeholder="ID" value={formData.reimburseId} onChange={(e) => handleInputChange(e, 'reimburseId')}/>
                    </div>
                 </div>            
                <div className="form__row">
                    <div className="form__row__left">
                    ...
                    <div className="form__row__right">
                        <BoxInput placeholder="Value" value={formData.nama} onChange={(e) => handleInputChange(e, 'nama')}/>
                    </div>
                 </div> 
                <div className="form__row">
                        <div className="form__row__left">
                ...
                <div className="form__row">
                    ...
                    <div className="form__row__right">
                        <TextArea placeholder="Note" value={formData.note} onChange={(e) => handleInputChange(e, 'note')}/>
                    </div>
                </div>


                <div className="form__row__bottom">
                    <Link to="/parameter/reimburse-view" className="cancel__button" text="Cancel">Cancel</Link>
