...
const DetaildataTimesheet = () => {
    ...
    if( informationText === "Data Diri") {
        api = 'https://treemas-api-405402.et.r.appspot.com/api/rekap/get-rekap-timesheet'
    ...
    // Data
     columns = [
        ...
        {
            name: "Project",
            selector: (row) => (row.projectId && row.projectId.projectId) ? row.projectId.projectId : '-',
            cellExport: (row) => (row.projectId && row.projectId.projectId) ? row.projectId.projectId : '-',
            sortable: true
          }
          ,  
        {
       ...
       dataTable = {
        ...
        api = 'https://treemas-api-405402.et.r.appspot.com/api/detail-data/get-rekap-timesheet/data-member'
