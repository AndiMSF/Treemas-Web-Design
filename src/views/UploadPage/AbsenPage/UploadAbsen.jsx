    ...
    const handleFileUpload = async (e) => {
     ...
     const columns = [
      ...
      <div style={getRowColor(row)}>
        {row.status}
        {row.isApprove === "1" ? (
          <span style={{ backgroundColor: '#AAD9BB', color: '0000', borderRadius: '5px', padding: '5px',display: 'block', width: '100px', textAlign: 'center', fontWeight: '600'}}> DISETUJUI</span>
        ) : null}
        {row.isApprove === "0" ? (
          <span style={{ backgroundColor: '#E74646', color: '0000', borderRadius: '5px', padding: '5px', display: 'block',width: '100px', textAlign: 'center', fontWeight: '600' }}> DITOLAK </span>
        ) : null}
        {row.isApprove !== "1" && row.isApprove !== "0" ? (
          <span style={{ backgroundColor: '#FAEF9B', color: '0000', borderRadius: '5px', padding: '5px', display: 'block',width: '100px', textAlign: 'center', fontWeight: '600' }}> MENUNGGU </span>
        ) : null}
      </div>
    ),
